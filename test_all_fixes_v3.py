...
class TestAPIAuthentication(unittest.TestCase):
    ...
    def test_authenticate(self):
        """Test authentication with mocked API"""
        # Mock the API class
        api_mock = MagicMock()
        ...
        success = api_mock.authenticate(private_key, wallet_address)
        self.assertTrue(success)
...
class TestWalletGeneration(unittest.TestCase):
    ...
    def test_generate_wallet(self, mock_create):
        ...
        # Generate a new wallet using the mocked Account.create
