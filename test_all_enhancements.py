...
class TestEnhancements(unittest.TestCase):
    ...
    def setUp(self):
        ...
        patcher = patch('core.connection_manager_enhanced.EnhancedAPI')
    ...
    def test_connection_manager_methods(self):
        ...
        self.assertTrue(self.connection_manager.auto_reconnect)
    ...
    def test_security_manager_methods(self):
        ...
        self.security_manager.store_private_key("test_address", "test_private_key")
        retrieved_key = self.security_manager.get_private_key("test_address")
        self.assertEqual(retrieved_key, "test_private_key")
        
        # Test clear private key
        self.security_manager.clear_private_key("test_address")
        retrieved_key = self.security_manager.get_private_key("test_address")
