...
from gui.enhanced_gui_fixed_v3 import TradingDashboard  # Use the enhanced GUI with wallet creation
...
class HyperliquidTradingBot:
    ...
    def start_gui(self):
        ...
        try:
            # Initialize the GUI with the enhanced implementation
                ...
                if cmd == "exit":
                    ...
                    if save_wallet == 'y':
                        ...
                        if success:
                            ...
                            # Ask if user wants to connect with the new wallet
                            connect_wallet = input("\nDo you want to connect with this new wallet? (y/n): ").strip().lower()
                            
                            if connect_wallet == 'y':
                                print("\nConnecting with new wallet...")
                                success = self.api_client.authenticate(new_privkey_hex, new_address)
                                if success:
                                    print("✅ Connected successfully with new wallet!")
                                    ...
                                    print("❌ Failed to connect with new wallet")
                        else:
