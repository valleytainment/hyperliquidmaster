...
class TestPrivateKeyHandling(unittest.TestCase):
    ...
    def test_api_connection(self, mock_info, mock_exchange):
        ...
        # Verify Exchange.set_private_key was called with any argument
        # (we don't care about the exact format since the API handles it)
        mock_exchange_instance.set_private_key.assert_called_once()
